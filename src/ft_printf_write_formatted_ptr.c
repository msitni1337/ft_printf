...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_write_formatted_ptr.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: msitni <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 23:41:31 by msitni            #+#    #+#             */
/*   Updated: 2023/12/05 23:41:32 by msitni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	write_ptr_padding(t_format *format, int ptr_formatted_char_count,
		int *print_c)
{
