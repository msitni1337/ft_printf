...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_write_formatted_number.c                 :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: msitni <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 23:41:15 by msitni            #+#    #+#             */
/*   Updated: 2023/12/05 23:41:16 by msitni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	write_padding_and_sign(t_format *format, int nb,
		int formatted_char_count, int *print_c)
{
